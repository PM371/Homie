...
const About = () => {
  return (
    <div>
      ...
      <div className='text-center text-2xl pt-20 text-black mb-10'>
        <p>ABOUT US</p>
      </div>
      ...
      <div className='flex flex-col md:flex-row mb-20'>
        <div className='border px-10 md:px-16 py-8 sm:py-16 flex flex-col gap-5 text-[15px] hover:bg-[#7A98AB] hover:text-white transition-all duration-300 text-black cursor-pointer'>
          <b>EFFICIENCY :</b>
